...
\begin{figure}
  \centerline{\includegraphics[width=4in]{len_vs_acc}}
  \caption{Mean search engine accuracy for each query length}\label{fig:lengths}
\end{figure}

\begin{figure}
  \centerline{\includegraphics[width=4in]{eng_vs_acc}}
  \caption{Mean accuracies over all query lengths}\label{fig:searchengines}
\end{figure}
